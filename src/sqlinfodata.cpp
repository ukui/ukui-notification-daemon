...
sqlInfoData::sqlInfoData(QObject *parent) : QObject(parent)
{
...
void sqlInfoData::addOne(notifyReceiveInfo *entity)
{
...
void sqlInfoData::addAll(QList<notifyReceiveInfo *> entities)
{
    for (notifyReceiveInfo *entity : entities) {
        addOne(entity);
    }
}

void sqlInfoData::removeOne(const QString &id)
{
...
QString sqlInfoData::getById(const QString &id)
{
...
void sqlInfoData::attemptCreateTable()
{
